...
export interface HighScore { 'moves' : bigint, 'timestamp' : bigint }
export interface UserProfile { 'name' : string }
export interface _SERVICE {
  'getLeaderboard' : ActorMethod<[], Array<[Principal, HighScore]>>,
  'getMyHighScore' : ActorMethod<[], [] | [HighScore]>,
  'getUserProfile' : ActorMethod<[], [] | [UserProfile]>,
  'initializeAuth' : ActorMethod<[], undefined>,
  'isCurrentUserAdmin' : ActorMethod<[], boolean>,
  'saveHighScore' : ActorMethod<[bigint], undefined>,
